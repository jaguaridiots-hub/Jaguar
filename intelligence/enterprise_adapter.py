...
class EnterpriseAdapter:
    ...
    def process(self, state):
        ...
        state.bos = bos_active

        state.choch = choch_active

        state.liquidity = liquidity_active

        state.order_block = order_block_active

        state.fvg = fvg_active
        ...
        state.decision = legacy_decision
