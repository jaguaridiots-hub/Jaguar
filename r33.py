...
volume_key, volume_value = find_dict_entry(
    return_dict,
    "volume",
)
...
print(
    "VOLUME_VALUE_TYPE:",
    type(volume_value).__name__,
)

print(
    "VOLUME_VALUE_SOURCE:",
    ast.unparse(volume_value),
)
...
if isinstance(volume_value.func, ast.Name):
    root = volume_value.func.id
else:
    root = None
...
print(
    "VOLUME_IMPORT_RECORD:",
    imports.get(root),
)

volume_import_authority = (
    imports.get(root) == {
