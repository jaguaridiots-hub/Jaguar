...
macd_key, macd_value = find_dict_entry(
    return_dict,
    "macd",
)
...
print(
    "MACD_VALUE_TYPE:",
    type(macd_value).__name__,
)

print(
    "MACD_VALUE_SOURCE:",
    ast.unparse(macd_value),
)
...
if isinstance(macd_value.func, ast.Name):
    root = macd_value.func.id
else:
    root = None
