...
"""
R31
Bollinger Bands Import Authority
"""
...
bb_key, bb_value = find_dict_entry(
    return_dict,
    "bollinger",
)
...
print(
    "BOLLINGER_VALUE_TYPE:",
    type(bb_value).__name__,
)

print(
    "BOLLINGER_VALUE_SOURCE:",
    ast.unparse(bb_value),
)
...
if isinstance(bb_value.func, ast.Name):
    root = bb_value.func.id
else:
    root = None
...
print(
    "BOLLINGER_IMPORT_RECORD:",
    imports.get(root),
)

bollinger_import_authority = (
    imports.get(root) == {
