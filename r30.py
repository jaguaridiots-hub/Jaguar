...
vwap_key, vwap_value = find_dict_entry(
    return_dict,
    "vwap",
)
...
print(
    "VWAP_VALUE_TYPE:",
    type(vwap_value).__name__,
)

print(
    "VWAP_VALUE_SOURCE:",
    ast.unparse(vwap_value),
)
...
if isinstance(vwap_value.func, ast.Name):
    root = vwap_value.func.id
else:
    root = None
