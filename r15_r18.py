...
PHASE = (
    "PHASE 7.5E73B-R10-R4-R8-R15-R18 "
...
print(
    "R15_R18_PRE_DIAGNOSTIC_AUTHORITY:",
    "PASS"
    if pre_authority
    else "FAIL",
)
...
rhs_call_authority = (
    single_assignment_authority
    and atr_data_assignments[0]["rhs_call_count"] == 1
)
...
if (
    ...
    classification = (
        "ATR_DATA_CALL_RHS_TRANSITIVELY_PROJECTS_"
    ...
    classification = (
        "ATR_DATA_CALL_RHS_TRANSITIVELY_REACHES_"
...
print(
    "ATR_DATA_EXACT_rhs_call_authority:",
    "PASS"
...
print(
    "ATR_DATA_EXACT_CALL_LINEAGE_AUTHORITY:",
    "PASS"
...
print(
    "R15_R18_CLASSIFICATION:",
    classification,
)

print(
    "R15_R18_NEXT_OWNER_CLASSIFICATION:",
    next_owner,
)
...
print(
    "R15_R18_TARGET_OWNER:",
    "indicators/indicator_engine.py::update_market_state",
)

print(
    "R15_R18_TARGET_LOCAL_SYMBOL:",
    "atr_data",
)

print(
    "R15_R18_ATR_DATA_EXACT_ASSIGNMENT_COUNT:",
    len(atr_data_assignments),
)

print(
    "R15_R18_ATR_DATA_EXACT_RHS_TYPE:",
    (
...
print(
    "R15_R18_ATR_DATA_EXACT_RHS_SOURCE:",
    (
...
print(
    "R15_R18_ATR_DATA_EXACT_RHS_CALL_COUNT:",
    (
...
print(
    "R15_R18_ATR_DATA_RHS_ROOT_RECORD_COUNT:",
    len(rhs_root_records),
)

print(
    "R15_R18_ATR_DATA_RECURSIVE_LINEAGE_RECORD_COUNT:",
    len(lineage_records),
)

print(
    "R15_R18_ATR_DATA_RECURSIVE_TERMINAL_RECORD_COUNT:",
    len(terminal_records),
)

print(
    "R15_R18_ATR_DATA_CALL_BEARING_LINEAGE_RECORD_COUNT:",
    len(call_bearing_lineage_records),
)

print(
    "R15_R18_ATR_DATA_EXACT_ATR_IMPORT_CALL_LINEAGE_RECORD_COUNT:",
    len(exact_atr_import_call_records),
)

print(
    "R15_R18_ATR_DATA_PARAMETER_TERMINAL_RECORD_COUNT:",
    len(parameter_terminal_records),
)

print(
    "R15_R18_ATR_DATA_IMPORT_TERMINAL_RECORD_COUNT:",
    len(import_terminal_records),
)

print(
    "R15_R18_ATR_DATA_UNRESOLVED_TERMINAL_RECORD_COUNT:",
    len(unresolved_terminal_records),
)
...
print(
    "R15_ATR_DATA_CALL_PRODUCER_CAUSAL_AUTHORITY:",
    "PASS"
    if causal_authority
    else "FAIL",
)
...
print(
    ...
    (
        ...
        if final_authority
        else "STOP_AND_REPORT_R15_R18_AUTHORITY_FAILURE"
    ),
)
